...
import { emailValidate, passwordValidate, phoneValidate, usernameValidate } from '../../utils/functions';
                        ...
                        <div className='auth__error-hint'>
                          {!isUsernameFieldHasError &&
                            ...
                            usernameValidate(usernameValue) !== 'ok' && (
                              <span
                                data-test-id='hint'
                                dangerouslySetInnerHTML={{ __html: usernameValidate(usernameValue) }}
                              />
                            )}
